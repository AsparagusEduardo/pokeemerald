...
const u8 gText_DexSinnohTitle[] = _("SINNOH DEX");
const u8 gText_DexUnovaTitle[] = _("UNOVA DEX");
const u8 gText_DexKalosTitle[] = _("KALOS DEX");
const u8 gText_DexAlolaTitle[] = _("ALOLA DEX");
const u8 gText_DexGalarTitle[] = _("GALAR DEX");
const u8 gText_DexHisuiTitle[] = _("HISUI DEX");
const u8 gText_DexPaldeaTitle[] = _("PALDEA DEX");
const u8 gText_DexNatTitle[] = _("NATIONAL DEX");
const u8 gText_DexNewTitle[] = _("NEW POKéDEX");
...
const u8 gText_DexSinnohDescription[] = _("SINNOH region's POKéDEX");
const u8 gText_DexUnovaDescription[] = _("UNOVA region's POKéDEX");
const u8 gText_DexKalosDescription[] = _("KALOS region's POKéDEX");
const u8 gText_DexAlolaDescription[] = _("ALOLA region's POKéDEX");
const u8 gText_DexGalarDescription[] = _("GALAR region's POKéDEX");
const u8 gText_DexHisuiDescription[] = _("HISUI region's POKéDEX");
const u8 gText_DexPaldeaDescription[] = _("PALDEA region's POKéDEX");
const u8 gText_DexNatDescription[] = _("National edition POKéDEX");
const u8 gText_DexNewDescription[] = _("New National edition POKéDEX");
