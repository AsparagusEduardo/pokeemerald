...
const u8 gText_BrendanMatchCallDesc[] = _("RADNACHBAR");
const u8 gText_MayMatchCallDesc[] = _("RADNACHBAR");
...
const u8 gText_SchoolKidFemale[] = _("SCHULKIND");
const u8 gText_TrainerFemale[] = _("{PKMN}-TRAINER");
const u8 gText_LeaderPlural[] = _("LEITER");
