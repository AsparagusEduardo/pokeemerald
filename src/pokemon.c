...
#define NATIONAL_TO_NEW_POKEDEX(name)     [NEW_POKEDEX_##name - 1] = NATIONAL_DEX_##name

// Assigns all Hoenn Dex Indexes to a National Dex Index
static const u16 sNewPokedexToNationalOrder[NATIONAL_DEX_COUNT] =
{
    NATIONAL_TO_NEW_POKEDEX(BULBASAUR),
    NATIONAL_TO_NEW_POKEDEX(IVYSAUR),
    NATIONAL_TO_NEW_POKEDEX(VENUSAUR),
    NATIONAL_TO_NEW_POKEDEX(CHARMANDER),
    NATIONAL_TO_NEW_POKEDEX(CHARMELEON),
    NATIONAL_TO_NEW_POKEDEX(CHARIZARD),
    NATIONAL_TO_NEW_POKEDEX(SQUIRTLE),
    NATIONAL_TO_NEW_POKEDEX(WARTORTLE),
    NATIONAL_TO_NEW_POKEDEX(BLASTOISE),
    NATIONAL_TO_NEW_POKEDEX(CATERPIE),
    NATIONAL_TO_NEW_POKEDEX(METAPOD),
    NATIONAL_TO_NEW_POKEDEX(BUTTERFREE),
    NATIONAL_TO_NEW_POKEDEX(WEEDLE),
    NATIONAL_TO_NEW_POKEDEX(KAKUNA),
    NATIONAL_TO_NEW_POKEDEX(BEEDRILL),
    NATIONAL_TO_NEW_POKEDEX(PIDGEY),
    NATIONAL_TO_NEW_POKEDEX(PIDGEOTTO),
    NATIONAL_TO_NEW_POKEDEX(PIDGEOT),
    NATIONAL_TO_NEW_POKEDEX(RATTATA),
    NATIONAL_TO_NEW_POKEDEX(RATICATE),
    NATIONAL_TO_NEW_POKEDEX(SPEAROW),
    NATIONAL_TO_NEW_POKEDEX(FEAROW),
    NATIONAL_TO_NEW_POKEDEX(EKANS),
    NATIONAL_TO_NEW_POKEDEX(ARBOK),
    NATIONAL_TO_NEW_POKEDEX(PICHU),
    NATIONAL_TO_NEW_POKEDEX(PIKACHU),
    NATIONAL_TO_NEW_POKEDEX(RAICHU),
    NATIONAL_TO_NEW_POKEDEX(SANDSHREW),
    NATIONAL_TO_NEW_POKEDEX(SANDSLASH),
    NATIONAL_TO_NEW_POKEDEX(NIDORAN_F),
    NATIONAL_TO_NEW_POKEDEX(NIDORINA),
    NATIONAL_TO_NEW_POKEDEX(NIDOQUEEN),
    NATIONAL_TO_NEW_POKEDEX(NIDORAN_M),
    NATIONAL_TO_NEW_POKEDEX(NIDORINO),
    NATIONAL_TO_NEW_POKEDEX(NIDOKING),
    NATIONAL_TO_NEW_POKEDEX(CLEFFA),
    NATIONAL_TO_NEW_POKEDEX(CLEFAIRY),
    NATIONAL_TO_NEW_POKEDEX(CLEFABLE),
    NATIONAL_TO_NEW_POKEDEX(VULPIX),
    NATIONAL_TO_NEW_POKEDEX(NINETALES),
    NATIONAL_TO_NEW_POKEDEX(IGGLYBUFF),
    NATIONAL_TO_NEW_POKEDEX(JIGGLYPUFF),
    NATIONAL_TO_NEW_POKEDEX(WIGGLYTUFF),
    NATIONAL_TO_NEW_POKEDEX(ZUBAT),
    NATIONAL_TO_NEW_POKEDEX(GOLBAT),
    NATIONAL_TO_NEW_POKEDEX(CROBAT),
    NATIONAL_TO_NEW_POKEDEX(ODDISH),
    NATIONAL_TO_NEW_POKEDEX(GLOOM),
    NATIONAL_TO_NEW_POKEDEX(VILEPLUME),
    NATIONAL_TO_NEW_POKEDEX(BELLOSSOM),
    NATIONAL_TO_NEW_POKEDEX(PARAS),
    NATIONAL_TO_NEW_POKEDEX(PARASECT),
    NATIONAL_TO_NEW_POKEDEX(VENONAT),
    NATIONAL_TO_NEW_POKEDEX(VENOMOTH),
    NATIONAL_TO_NEW_POKEDEX(DIGLETT),
    NATIONAL_TO_NEW_POKEDEX(DUGTRIO),
    NATIONAL_TO_NEW_POKEDEX(MEOWTH),
    NATIONAL_TO_NEW_POKEDEX(PERSIAN),
    NATIONAL_TO_NEW_POKEDEX(PERRSERKER),
    NATIONAL_TO_NEW_POKEDEX(PSYDUCK),
    NATIONAL_TO_NEW_POKEDEX(GOLDUCK),
    NATIONAL_TO_NEW_POKEDEX(MANKEY),
    NATIONAL_TO_NEW_POKEDEX(PRIMEAPE),
    NATIONAL_TO_NEW_POKEDEX(ANNIHILAPE),
    NATIONAL_TO_NEW_POKEDEX(GROWLITHE),
    NATIONAL_TO_NEW_POKEDEX(ARCANINE),
    NATIONAL_TO_NEW_POKEDEX(POLIWAG),
    NATIONAL_TO_NEW_POKEDEX(POLIWHIRL),
    NATIONAL_TO_NEW_POKEDEX(POLIWRATH),
    NATIONAL_TO_NEW_POKEDEX(POLITOED),
    NATIONAL_TO_NEW_POKEDEX(ABRA),
    NATIONAL_TO_NEW_POKEDEX(KADABRA),
    NATIONAL_TO_NEW_POKEDEX(ALAKAZAM),
    NATIONAL_TO_NEW_POKEDEX(MACHOP),
    NATIONAL_TO_NEW_POKEDEX(MACHOKE),
    NATIONAL_TO_NEW_POKEDEX(MACHAMP),
    NATIONAL_TO_NEW_POKEDEX(BELLSPROUT),
    NATIONAL_TO_NEW_POKEDEX(WEEPINBELL),
    NATIONAL_TO_NEW_POKEDEX(VICTREEBEL),
    NATIONAL_TO_NEW_POKEDEX(TENTACOOL),
    NATIONAL_TO_NEW_POKEDEX(TENTACRUEL),
    NATIONAL_TO_NEW_POKEDEX(GEODUDE),
    NATIONAL_TO_NEW_POKEDEX(GRAVELER),
    NATIONAL_TO_NEW_POKEDEX(GOLEM),
    NATIONAL_TO_NEW_POKEDEX(PONYTA),
    NATIONAL_TO_NEW_POKEDEX(RAPIDASH),
    NATIONAL_TO_NEW_POKEDEX(SLOWPOKE),
    NATIONAL_TO_NEW_POKEDEX(SLOWBRO),
    NATIONAL_TO_NEW_POKEDEX(SLOWKING),
    NATIONAL_TO_NEW_POKEDEX(MAGNEMITE),
    NATIONAL_TO_NEW_POKEDEX(MAGNETON),
    NATIONAL_TO_NEW_POKEDEX(MAGNEZONE),
    NATIONAL_TO_NEW_POKEDEX(FARFETCHD),
    NATIONAL_TO_NEW_POKEDEX(SIRFETCHD),
    NATIONAL_TO_NEW_POKEDEX(DODUO),
    NATIONAL_TO_NEW_POKEDEX(DODRIO),
    NATIONAL_TO_NEW_POKEDEX(SEEL),
    NATIONAL_TO_NEW_POKEDEX(DEWGONG),
    NATIONAL_TO_NEW_POKEDEX(GRIMER),
    NATIONAL_TO_NEW_POKEDEX(MUK),
    NATIONAL_TO_NEW_POKEDEX(SHELLDER),
    NATIONAL_TO_NEW_POKEDEX(CLOYSTER),
    NATIONAL_TO_NEW_POKEDEX(GASTLY),
    NATIONAL_TO_NEW_POKEDEX(HAUNTER),
    NATIONAL_TO_NEW_POKEDEX(GENGAR),
    NATIONAL_TO_NEW_POKEDEX(ONIX),
    NATIONAL_TO_NEW_POKEDEX(STEELIX),
    NATIONAL_TO_NEW_POKEDEX(DROWZEE),
    NATIONAL_TO_NEW_POKEDEX(HYPNO),
    NATIONAL_TO_NEW_POKEDEX(KRABBY),
    NATIONAL_TO_NEW_POKEDEX(KINGLER),
    NATIONAL_TO_NEW_POKEDEX(VOLTORB),
    NATIONAL_TO_NEW_POKEDEX(ELECTRODE),
    NATIONAL_TO_NEW_POKEDEX(EXEGGCUTE),
    NATIONAL_TO_NEW_POKEDEX(EXEGGUTOR),
    NATIONAL_TO_NEW_POKEDEX(CUBONE),
    NATIONAL_TO_NEW_POKEDEX(MAROWAK),
    NATIONAL_TO_NEW_POKEDEX(TYROGUE),
    NATIONAL_TO_NEW_POKEDEX(HITMONLEE),
    NATIONAL_TO_NEW_POKEDEX(HITMONCHAN),
    NATIONAL_TO_NEW_POKEDEX(HITMONTOP),
    NATIONAL_TO_NEW_POKEDEX(LICKITUNG),
    NATIONAL_TO_NEW_POKEDEX(LICKILICKY),
    NATIONAL_TO_NEW_POKEDEX(KOFFING),
    NATIONAL_TO_NEW_POKEDEX(WEEZING),
    NATIONAL_TO_NEW_POKEDEX(RHYHORN),
    NATIONAL_TO_NEW_POKEDEX(RHYDON),
    NATIONAL_TO_NEW_POKEDEX(RHYPERIOR),
    NATIONAL_TO_NEW_POKEDEX(HAPPINY),
    NATIONAL_TO_NEW_POKEDEX(CHANSEY),
    NATIONAL_TO_NEW_POKEDEX(BLISSEY),
    NATIONAL_TO_NEW_POKEDEX(TANGELA),
    NATIONAL_TO_NEW_POKEDEX(TANGROWTH),
    NATIONAL_TO_NEW_POKEDEX(KANGASKHAN),
    NATIONAL_TO_NEW_POKEDEX(HORSEA),
    NATIONAL_TO_NEW_POKEDEX(SEADRA),
    NATIONAL_TO_NEW_POKEDEX(KINGDRA),
    NATIONAL_TO_NEW_POKEDEX(GOLDEEN),
    NATIONAL_TO_NEW_POKEDEX(SEAKING),
    NATIONAL_TO_NEW_POKEDEX(STARYU),
    NATIONAL_TO_NEW_POKEDEX(STARMIE),
    NATIONAL_TO_NEW_POKEDEX(MIME_JR),
    NATIONAL_TO_NEW_POKEDEX(MR_MIME),
    NATIONAL_TO_NEW_POKEDEX(MR_RIME),
    NATIONAL_TO_NEW_POKEDEX(SCYTHER),
    NATIONAL_TO_NEW_POKEDEX(SCIZOR),
    NATIONAL_TO_NEW_POKEDEX(KLEAVOR),
    NATIONAL_TO_NEW_POKEDEX(SMOOCHUM),
    NATIONAL_TO_NEW_POKEDEX(JYNX),
    NATIONAL_TO_NEW_POKEDEX(ELEKID),
    NATIONAL_TO_NEW_POKEDEX(ELECTABUZZ),
    NATIONAL_TO_NEW_POKEDEX(ELECTIVIRE),
    NATIONAL_TO_NEW_POKEDEX(MAGBY),
    NATIONAL_TO_NEW_POKEDEX(MAGMAR),
    NATIONAL_TO_NEW_POKEDEX(MAGMORTAR),
    NATIONAL_TO_NEW_POKEDEX(PINSIR),
    NATIONAL_TO_NEW_POKEDEX(TAUROS),
    NATIONAL_TO_NEW_POKEDEX(MAGIKARP),
    NATIONAL_TO_NEW_POKEDEX(GYARADOS),
    NATIONAL_TO_NEW_POKEDEX(LAPRAS),
    NATIONAL_TO_NEW_POKEDEX(DITTO),
    NATIONAL_TO_NEW_POKEDEX(EEVEE),
    NATIONAL_TO_NEW_POKEDEX(VAPOREON),
    NATIONAL_TO_NEW_POKEDEX(JOLTEON),
    NATIONAL_TO_NEW_POKEDEX(FLAREON),
    NATIONAL_TO_NEW_POKEDEX(ESPEON),
    NATIONAL_TO_NEW_POKEDEX(UMBREON),
    NATIONAL_TO_NEW_POKEDEX(LEAFEON),
    NATIONAL_TO_NEW_POKEDEX(GLACEON),
    NATIONAL_TO_NEW_POKEDEX(SYLVEON),
    NATIONAL_TO_NEW_POKEDEX(PORYGON),
    NATIONAL_TO_NEW_POKEDEX(PORYGON2),
    NATIONAL_TO_NEW_POKEDEX(PORYGON_Z),
    NATIONAL_TO_NEW_POKEDEX(OMANYTE),
    NATIONAL_TO_NEW_POKEDEX(OMASTAR),
    NATIONAL_TO_NEW_POKEDEX(KABUTO),
    NATIONAL_TO_NEW_POKEDEX(KABUTOPS),
    NATIONAL_TO_NEW_POKEDEX(AERODACTYL),
    NATIONAL_TO_NEW_POKEDEX(MUNCHLAX),
    NATIONAL_TO_NEW_POKEDEX(SNORLAX),
    NATIONAL_TO_NEW_POKEDEX(ARTICUNO),
    NATIONAL_TO_NEW_POKEDEX(ZAPDOS),
    NATIONAL_TO_NEW_POKEDEX(MOLTRES),
    NATIONAL_TO_NEW_POKEDEX(DRATINI),
    NATIONAL_TO_NEW_POKEDEX(DRAGONAIR),
    NATIONAL_TO_NEW_POKEDEX(DRAGONITE),
    NATIONAL_TO_NEW_POKEDEX(MEWTWO),
    NATIONAL_TO_NEW_POKEDEX(MEW),
    NATIONAL_TO_NEW_POKEDEX(CHIKORITA),
    NATIONAL_TO_NEW_POKEDEX(BAYLEEF),
    NATIONAL_TO_NEW_POKEDEX(MEGANIUM),
    NATIONAL_TO_NEW_POKEDEX(CYNDAQUIL),
    NATIONAL_TO_NEW_POKEDEX(QUILAVA),
    NATIONAL_TO_NEW_POKEDEX(TYPHLOSION),
    NATIONAL_TO_NEW_POKEDEX(TOTODILE),
    NATIONAL_TO_NEW_POKEDEX(CROCONAW),
    NATIONAL_TO_NEW_POKEDEX(FERALIGATR),
    NATIONAL_TO_NEW_POKEDEX(SENTRET),
    NATIONAL_TO_NEW_POKEDEX(FURRET),
    NATIONAL_TO_NEW_POKEDEX(HOOTHOOT),
    NATIONAL_TO_NEW_POKEDEX(NOCTOWL),
    NATIONAL_TO_NEW_POKEDEX(LEDYBA),
    NATIONAL_TO_NEW_POKEDEX(LEDIAN),
    NATIONAL_TO_NEW_POKEDEX(SPINARAK),
    NATIONAL_TO_NEW_POKEDEX(ARIADOS),
    NATIONAL_TO_NEW_POKEDEX(CHINCHOU),
    NATIONAL_TO_NEW_POKEDEX(LANTURN),
    NATIONAL_TO_NEW_POKEDEX(TOGEPI),
    NATIONAL_TO_NEW_POKEDEX(TOGETIC),
    NATIONAL_TO_NEW_POKEDEX(TOGEKISS),
    NATIONAL_TO_NEW_POKEDEX(NATU),
    NATIONAL_TO_NEW_POKEDEX(XATU),
    NATIONAL_TO_NEW_POKEDEX(MAREEP),
    NATIONAL_TO_NEW_POKEDEX(FLAAFFY),
    NATIONAL_TO_NEW_POKEDEX(AMPHAROS),
    NATIONAL_TO_NEW_POKEDEX(AZURILL),
    NATIONAL_TO_NEW_POKEDEX(MARILL),
    NATIONAL_TO_NEW_POKEDEX(AZUMARILL),
    NATIONAL_TO_NEW_POKEDEX(BONSLY),
    NATIONAL_TO_NEW_POKEDEX(SUDOWOODO),
    NATIONAL_TO_NEW_POKEDEX(HOPPIP),
    NATIONAL_TO_NEW_POKEDEX(SKIPLOOM),
    NATIONAL_TO_NEW_POKEDEX(JUMPLUFF),
    NATIONAL_TO_NEW_POKEDEX(AIPOM),
    NATIONAL_TO_NEW_POKEDEX(AMBIPOM),
    NATIONAL_TO_NEW_POKEDEX(SUNKERN),
    NATIONAL_TO_NEW_POKEDEX(SUNFLORA),
    NATIONAL_TO_NEW_POKEDEX(YANMA),
    NATIONAL_TO_NEW_POKEDEX(YANMEGA),
    NATIONAL_TO_NEW_POKEDEX(WOOPER),
    NATIONAL_TO_NEW_POKEDEX(QUAGSIRE),
    NATIONAL_TO_NEW_POKEDEX(CLODSIRE),
    NATIONAL_TO_NEW_POKEDEX(MURKROW),
    NATIONAL_TO_NEW_POKEDEX(HONCHKROW),
    NATIONAL_TO_NEW_POKEDEX(MISDREAVUS),
    NATIONAL_TO_NEW_POKEDEX(MISMAGIUS),
    NATIONAL_TO_NEW_POKEDEX(UNOWN),
    NATIONAL_TO_NEW_POKEDEX(WYNAUT),
    NATIONAL_TO_NEW_POKEDEX(WOBBUFFET),
    NATIONAL_TO_NEW_POKEDEX(GIRAFARIG),
    NATIONAL_TO_NEW_POKEDEX(FARIGIRAF),
    NATIONAL_TO_NEW_POKEDEX(PINECO),
    NATIONAL_TO_NEW_POKEDEX(FORRETRESS),
    NATIONAL_TO_NEW_POKEDEX(DUNSPARCE),
    NATIONAL_TO_NEW_POKEDEX(DUDUNSPARCE),
    NATIONAL_TO_NEW_POKEDEX(GLIGAR),
    NATIONAL_TO_NEW_POKEDEX(GLISCOR),
    NATIONAL_TO_NEW_POKEDEX(SNUBBULL),
    NATIONAL_TO_NEW_POKEDEX(GRANBULL),
    NATIONAL_TO_NEW_POKEDEX(QWILFISH),
    NATIONAL_TO_NEW_POKEDEX(OVERQWIL),
    NATIONAL_TO_NEW_POKEDEX(SHUCKLE),
    NATIONAL_TO_NEW_POKEDEX(HERACROSS),
    NATIONAL_TO_NEW_POKEDEX(SNEASEL),
    NATIONAL_TO_NEW_POKEDEX(WEAVILE),
    NATIONAL_TO_NEW_POKEDEX(SNEASLER),
    NATIONAL_TO_NEW_POKEDEX(TEDDIURSA),
    NATIONAL_TO_NEW_POKEDEX(URSARING),
    NATIONAL_TO_NEW_POKEDEX(URSALUNA),
    NATIONAL_TO_NEW_POKEDEX(SLUGMA),
    NATIONAL_TO_NEW_POKEDEX(MAGCARGO),
    NATIONAL_TO_NEW_POKEDEX(SWINUB),
    NATIONAL_TO_NEW_POKEDEX(PILOSWINE),
    NATIONAL_TO_NEW_POKEDEX(MAMOSWINE),
    NATIONAL_TO_NEW_POKEDEX(CORSOLA),
    NATIONAL_TO_NEW_POKEDEX(CURSOLA),
    NATIONAL_TO_NEW_POKEDEX(REMORAID),
    NATIONAL_TO_NEW_POKEDEX(OCTILLERY),
    NATIONAL_TO_NEW_POKEDEX(DELIBIRD),
    NATIONAL_TO_NEW_POKEDEX(MANTYKE),
    NATIONAL_TO_NEW_POKEDEX(MANTINE),
    NATIONAL_TO_NEW_POKEDEX(SKARMORY),
    NATIONAL_TO_NEW_POKEDEX(HOUNDOUR),
    NATIONAL_TO_NEW_POKEDEX(HOUNDOOM),
    NATIONAL_TO_NEW_POKEDEX(PHANPY),
    NATIONAL_TO_NEW_POKEDEX(DONPHAN),
    NATIONAL_TO_NEW_POKEDEX(STANTLER),
    NATIONAL_TO_NEW_POKEDEX(WYRDEER),
    NATIONAL_TO_NEW_POKEDEX(SMEARGLE),
    NATIONAL_TO_NEW_POKEDEX(MILTANK),
    NATIONAL_TO_NEW_POKEDEX(RAIKOU),
    NATIONAL_TO_NEW_POKEDEX(ENTEI),
    NATIONAL_TO_NEW_POKEDEX(SUICUNE),
    NATIONAL_TO_NEW_POKEDEX(LARVITAR),
    NATIONAL_TO_NEW_POKEDEX(PUPITAR),
    NATIONAL_TO_NEW_POKEDEX(TYRANITAR),
    NATIONAL_TO_NEW_POKEDEX(LUGIA),
    NATIONAL_TO_NEW_POKEDEX(HO_OH),
    NATIONAL_TO_NEW_POKEDEX(CELEBI),
    NATIONAL_TO_NEW_POKEDEX(TREECKO),
    NATIONAL_TO_NEW_POKEDEX(GROVYLE),
    NATIONAL_TO_NEW_POKEDEX(SCEPTILE),
    NATIONAL_TO_NEW_POKEDEX(TORCHIC),
    NATIONAL_TO_NEW_POKEDEX(COMBUSKEN),
    NATIONAL_TO_NEW_POKEDEX(BLAZIKEN),
    NATIONAL_TO_NEW_POKEDEX(MUDKIP),
    NATIONAL_TO_NEW_POKEDEX(MARSHTOMP),
    NATIONAL_TO_NEW_POKEDEX(SWAMPERT),
    NATIONAL_TO_NEW_POKEDEX(POOCHYENA),
    NATIONAL_TO_NEW_POKEDEX(MIGHTYENA),
    NATIONAL_TO_NEW_POKEDEX(ZIGZAGOON),
    NATIONAL_TO_NEW_POKEDEX(LINOONE),
    NATIONAL_TO_NEW_POKEDEX(OBSTAGOON),
    NATIONAL_TO_NEW_POKEDEX(WURMPLE),
    NATIONAL_TO_NEW_POKEDEX(SILCOON),
    NATIONAL_TO_NEW_POKEDEX(BEAUTIFLY),
    NATIONAL_TO_NEW_POKEDEX(CASCOON),
    NATIONAL_TO_NEW_POKEDEX(DUSTOX),
    NATIONAL_TO_NEW_POKEDEX(LOTAD),
    NATIONAL_TO_NEW_POKEDEX(LOMBRE),
    NATIONAL_TO_NEW_POKEDEX(LUDICOLO),
    NATIONAL_TO_NEW_POKEDEX(SEEDOT),
    NATIONAL_TO_NEW_POKEDEX(NUZLEAF),
    NATIONAL_TO_NEW_POKEDEX(SHIFTRY),
    NATIONAL_TO_NEW_POKEDEX(TAILLOW),
    NATIONAL_TO_NEW_POKEDEX(SWELLOW),
    NATIONAL_TO_NEW_POKEDEX(WINGULL),
    NATIONAL_TO_NEW_POKEDEX(PELIPPER),
    NATIONAL_TO_NEW_POKEDEX(RALTS),
    NATIONAL_TO_NEW_POKEDEX(KIRLIA),
    NATIONAL_TO_NEW_POKEDEX(GARDEVOIR),
    NATIONAL_TO_NEW_POKEDEX(GALLADE),
    NATIONAL_TO_NEW_POKEDEX(SURSKIT),
    NATIONAL_TO_NEW_POKEDEX(MASQUERAIN),
    NATIONAL_TO_NEW_POKEDEX(SHROOMISH),
    NATIONAL_TO_NEW_POKEDEX(BRELOOM),
    NATIONAL_TO_NEW_POKEDEX(SLAKOTH),
    NATIONAL_TO_NEW_POKEDEX(VIGOROTH),
    NATIONAL_TO_NEW_POKEDEX(SLAKING),
    NATIONAL_TO_NEW_POKEDEX(NINCADA),
    NATIONAL_TO_NEW_POKEDEX(NINJASK),
    NATIONAL_TO_NEW_POKEDEX(SHEDINJA),
    NATIONAL_TO_NEW_POKEDEX(WHISMUR),
    NATIONAL_TO_NEW_POKEDEX(LOUDRED),
    NATIONAL_TO_NEW_POKEDEX(EXPLOUD),
    NATIONAL_TO_NEW_POKEDEX(MAKUHITA),
    NATIONAL_TO_NEW_POKEDEX(HARIYAMA),
    NATIONAL_TO_NEW_POKEDEX(NOSEPASS),
    NATIONAL_TO_NEW_POKEDEX(PROBOPASS),
    NATIONAL_TO_NEW_POKEDEX(SKITTY),
    NATIONAL_TO_NEW_POKEDEX(DELCATTY),
    NATIONAL_TO_NEW_POKEDEX(SABLEYE),
    NATIONAL_TO_NEW_POKEDEX(MAWILE),
    NATIONAL_TO_NEW_POKEDEX(ARON),
    NATIONAL_TO_NEW_POKEDEX(LAIRON),
    NATIONAL_TO_NEW_POKEDEX(AGGRON),
    NATIONAL_TO_NEW_POKEDEX(MEDITITE),
    NATIONAL_TO_NEW_POKEDEX(MEDICHAM),
    NATIONAL_TO_NEW_POKEDEX(ELECTRIKE),
    NATIONAL_TO_NEW_POKEDEX(MANECTRIC),
    NATIONAL_TO_NEW_POKEDEX(PLUSLE),
    NATIONAL_TO_NEW_POKEDEX(MINUN),
    NATIONAL_TO_NEW_POKEDEX(VOLBEAT),
    NATIONAL_TO_NEW_POKEDEX(ILLUMISE),
    NATIONAL_TO_NEW_POKEDEX(BUDEW),
    NATIONAL_TO_NEW_POKEDEX(ROSELIA),
    NATIONAL_TO_NEW_POKEDEX(ROSERADE),
    NATIONAL_TO_NEW_POKEDEX(GULPIN),
    NATIONAL_TO_NEW_POKEDEX(SWALOT),
    NATIONAL_TO_NEW_POKEDEX(CARVANHA),
    NATIONAL_TO_NEW_POKEDEX(SHARPEDO),
    NATIONAL_TO_NEW_POKEDEX(WAILMER),
    NATIONAL_TO_NEW_POKEDEX(WAILORD),
    NATIONAL_TO_NEW_POKEDEX(NUMEL),
    NATIONAL_TO_NEW_POKEDEX(CAMERUPT),
    NATIONAL_TO_NEW_POKEDEX(TORKOAL),
    NATIONAL_TO_NEW_POKEDEX(SPOINK),
    NATIONAL_TO_NEW_POKEDEX(GRUMPIG),
    NATIONAL_TO_NEW_POKEDEX(SPINDA),
    NATIONAL_TO_NEW_POKEDEX(TRAPINCH),
    NATIONAL_TO_NEW_POKEDEX(VIBRAVA),
    NATIONAL_TO_NEW_POKEDEX(FLYGON),
    NATIONAL_TO_NEW_POKEDEX(CACNEA),
    NATIONAL_TO_NEW_POKEDEX(CACTURNE),
    NATIONAL_TO_NEW_POKEDEX(SWABLU),
    NATIONAL_TO_NEW_POKEDEX(ALTARIA),
    NATIONAL_TO_NEW_POKEDEX(ZANGOOSE),
    NATIONAL_TO_NEW_POKEDEX(SEVIPER),
    NATIONAL_TO_NEW_POKEDEX(LUNATONE),
    NATIONAL_TO_NEW_POKEDEX(SOLROCK),
    NATIONAL_TO_NEW_POKEDEX(BARBOACH),
    NATIONAL_TO_NEW_POKEDEX(WHISCASH),
    NATIONAL_TO_NEW_POKEDEX(CORPHISH),
    NATIONAL_TO_NEW_POKEDEX(CRAWDAUNT),
    NATIONAL_TO_NEW_POKEDEX(BALTOY),
    NATIONAL_TO_NEW_POKEDEX(CLAYDOL),
    NATIONAL_TO_NEW_POKEDEX(LILEEP),
    NATIONAL_TO_NEW_POKEDEX(CRADILY),
    NATIONAL_TO_NEW_POKEDEX(ANORITH),
    NATIONAL_TO_NEW_POKEDEX(ARMALDO),
    NATIONAL_TO_NEW_POKEDEX(FEEBAS),
    NATIONAL_TO_NEW_POKEDEX(MILOTIC),
    NATIONAL_TO_NEW_POKEDEX(CASTFORM),
    NATIONAL_TO_NEW_POKEDEX(KECLEON),
    NATIONAL_TO_NEW_POKEDEX(SHUPPET),
    NATIONAL_TO_NEW_POKEDEX(BANETTE),
    NATIONAL_TO_NEW_POKEDEX(DUSKULL),
    NATIONAL_TO_NEW_POKEDEX(DUSCLOPS),
    NATIONAL_TO_NEW_POKEDEX(DUSKNOIR),
    NATIONAL_TO_NEW_POKEDEX(TROPIUS),
    NATIONAL_TO_NEW_POKEDEX(CHINGLING),
    NATIONAL_TO_NEW_POKEDEX(CHIMECHO),
    NATIONAL_TO_NEW_POKEDEX(ABSOL),
    NATIONAL_TO_NEW_POKEDEX(SNORUNT),
    NATIONAL_TO_NEW_POKEDEX(GLALIE),
    NATIONAL_TO_NEW_POKEDEX(FROSLASS),
    NATIONAL_TO_NEW_POKEDEX(SPHEAL),
    NATIONAL_TO_NEW_POKEDEX(SEALEO),
    NATIONAL_TO_NEW_POKEDEX(WALREIN),
    NATIONAL_TO_NEW_POKEDEX(CLAMPERL),
    NATIONAL_TO_NEW_POKEDEX(HUNTAIL),
    NATIONAL_TO_NEW_POKEDEX(GOREBYSS),
    NATIONAL_TO_NEW_POKEDEX(RELICANTH),
    NATIONAL_TO_NEW_POKEDEX(LUVDISC),
    NATIONAL_TO_NEW_POKEDEX(BAGON),
    NATIONAL_TO_NEW_POKEDEX(SHELGON),
    NATIONAL_TO_NEW_POKEDEX(SALAMENCE),
    NATIONAL_TO_NEW_POKEDEX(BELDUM),
    NATIONAL_TO_NEW_POKEDEX(METANG),
    NATIONAL_TO_NEW_POKEDEX(METAGROSS),
    NATIONAL_TO_NEW_POKEDEX(REGIROCK),
    NATIONAL_TO_NEW_POKEDEX(REGICE),
    NATIONAL_TO_NEW_POKEDEX(REGISTEEL),
    NATIONAL_TO_NEW_POKEDEX(LATIAS),
    NATIONAL_TO_NEW_POKEDEX(LATIOS),
    NATIONAL_TO_NEW_POKEDEX(KYOGRE),
    NATIONAL_TO_NEW_POKEDEX(GROUDON),
    NATIONAL_TO_NEW_POKEDEX(RAYQUAZA),
    NATIONAL_TO_NEW_POKEDEX(JIRACHI),
    NATIONAL_TO_NEW_POKEDEX(DEOXYS),
    NATIONAL_TO_NEW_POKEDEX(TURTWIG),
    NATIONAL_TO_NEW_POKEDEX(GROTLE),
    NATIONAL_TO_NEW_POKEDEX(TORTERRA),
    NATIONAL_TO_NEW_POKEDEX(CHIMCHAR),
    NATIONAL_TO_NEW_POKEDEX(MONFERNO),
    NATIONAL_TO_NEW_POKEDEX(INFERNAPE),
    NATIONAL_TO_NEW_POKEDEX(PIPLUP),
    NATIONAL_TO_NEW_POKEDEX(PRINPLUP),
    NATIONAL_TO_NEW_POKEDEX(EMPOLEON),
    NATIONAL_TO_NEW_POKEDEX(STARLY),
    NATIONAL_TO_NEW_POKEDEX(STARAVIA),
    NATIONAL_TO_NEW_POKEDEX(STARAPTOR),
    NATIONAL_TO_NEW_POKEDEX(BIDOOF),
    NATIONAL_TO_NEW_POKEDEX(BIBAREL),
    NATIONAL_TO_NEW_POKEDEX(KRICKETOT),
    NATIONAL_TO_NEW_POKEDEX(KRICKETUNE),
    NATIONAL_TO_NEW_POKEDEX(SHINX),
    NATIONAL_TO_NEW_POKEDEX(LUXIO),
    NATIONAL_TO_NEW_POKEDEX(LUXRAY),
    NATIONAL_TO_NEW_POKEDEX(CRANIDOS),
    NATIONAL_TO_NEW_POKEDEX(RAMPARDOS),
    NATIONAL_TO_NEW_POKEDEX(SHIELDON),
    NATIONAL_TO_NEW_POKEDEX(BASTIODON),
    NATIONAL_TO_NEW_POKEDEX(BURMY),
    NATIONAL_TO_NEW_POKEDEX(WORMADAM),
    NATIONAL_TO_NEW_POKEDEX(MOTHIM),
    NATIONAL_TO_NEW_POKEDEX(COMBEE),
    NATIONAL_TO_NEW_POKEDEX(VESPIQUEN),
    NATIONAL_TO_NEW_POKEDEX(PACHIRISU),
    NATIONAL_TO_NEW_POKEDEX(BUIZEL),
    NATIONAL_TO_NEW_POKEDEX(FLOATZEL),
    NATIONAL_TO_NEW_POKEDEX(CHERUBI),
    NATIONAL_TO_NEW_POKEDEX(CHERRIM),
    NATIONAL_TO_NEW_POKEDEX(SHELLOS),
    NATIONAL_TO_NEW_POKEDEX(GASTRODON),
    NATIONAL_TO_NEW_POKEDEX(DRIFLOON),
    NATIONAL_TO_NEW_POKEDEX(DRIFBLIM),
    NATIONAL_TO_NEW_POKEDEX(BUNEARY),
    NATIONAL_TO_NEW_POKEDEX(LOPUNNY),
    NATIONAL_TO_NEW_POKEDEX(GLAMEOW),
    NATIONAL_TO_NEW_POKEDEX(PURUGLY),
    NATIONAL_TO_NEW_POKEDEX(STUNKY),
    NATIONAL_TO_NEW_POKEDEX(SKUNTANK),
    NATIONAL_TO_NEW_POKEDEX(BRONZOR),
    NATIONAL_TO_NEW_POKEDEX(BRONZONG),
    NATIONAL_TO_NEW_POKEDEX(CHATOT),
    NATIONAL_TO_NEW_POKEDEX(SPIRITOMB),
    NATIONAL_TO_NEW_POKEDEX(GIBLE),
    NATIONAL_TO_NEW_POKEDEX(GABITE),
    NATIONAL_TO_NEW_POKEDEX(GARCHOMP),
    NATIONAL_TO_NEW_POKEDEX(RIOLU),
    NATIONAL_TO_NEW_POKEDEX(LUCARIO),
    NATIONAL_TO_NEW_POKEDEX(HIPPOPOTAS),
    NATIONAL_TO_NEW_POKEDEX(HIPPOWDON),
    NATIONAL_TO_NEW_POKEDEX(SKORUPI),
    NATIONAL_TO_NEW_POKEDEX(DRAPION),
    NATIONAL_TO_NEW_POKEDEX(CROAGUNK),
    NATIONAL_TO_NEW_POKEDEX(TOXICROAK),
    NATIONAL_TO_NEW_POKEDEX(CARNIVINE),
    NATIONAL_TO_NEW_POKEDEX(FINNEON),
    NATIONAL_TO_NEW_POKEDEX(LUMINEON),
    NATIONAL_TO_NEW_POKEDEX(SNOVER),
    NATIONAL_TO_NEW_POKEDEX(ABOMASNOW),
    NATIONAL_TO_NEW_POKEDEX(ROTOM),
    NATIONAL_TO_NEW_POKEDEX(UXIE),
    NATIONAL_TO_NEW_POKEDEX(MESPRIT),
    NATIONAL_TO_NEW_POKEDEX(AZELF),
    NATIONAL_TO_NEW_POKEDEX(DIALGA),
    NATIONAL_TO_NEW_POKEDEX(PALKIA),
    NATIONAL_TO_NEW_POKEDEX(HEATRAN),
    NATIONAL_TO_NEW_POKEDEX(REGIGIGAS),
    NATIONAL_TO_NEW_POKEDEX(GIRATINA),
    NATIONAL_TO_NEW_POKEDEX(CRESSELIA),
    NATIONAL_TO_NEW_POKEDEX(PHIONE),
    NATIONAL_TO_NEW_POKEDEX(MANAPHY),
    NATIONAL_TO_NEW_POKEDEX(DARKRAI),
    NATIONAL_TO_NEW_POKEDEX(SHAYMIN),
    NATIONAL_TO_NEW_POKEDEX(ARCEUS),
    NATIONAL_TO_NEW_POKEDEX(VICTINI),
    NATIONAL_TO_NEW_POKEDEX(SNIVY),
    NATIONAL_TO_NEW_POKEDEX(SERVINE),
    NATIONAL_TO_NEW_POKEDEX(SERPERIOR),
    NATIONAL_TO_NEW_POKEDEX(TEPIG),
    NATIONAL_TO_NEW_POKEDEX(PIGNITE),
    NATIONAL_TO_NEW_POKEDEX(EMBOAR),
    NATIONAL_TO_NEW_POKEDEX(OSHAWOTT),
    NATIONAL_TO_NEW_POKEDEX(DEWOTT),
    NATIONAL_TO_NEW_POKEDEX(SAMUROTT),
    NATIONAL_TO_NEW_POKEDEX(PATRAT),
    NATIONAL_TO_NEW_POKEDEX(WATCHOG),
    NATIONAL_TO_NEW_POKEDEX(LILLIPUP),
    NATIONAL_TO_NEW_POKEDEX(HERDIER),
    NATIONAL_TO_NEW_POKEDEX(STOUTLAND),
    NATIONAL_TO_NEW_POKEDEX(PURRLOIN),
    NATIONAL_TO_NEW_POKEDEX(LIEPARD),
    NATIONAL_TO_NEW_POKEDEX(PANSAGE),
    NATIONAL_TO_NEW_POKEDEX(SIMISAGE),
    NATIONAL_TO_NEW_POKEDEX(PANSEAR),
    NATIONAL_TO_NEW_POKEDEX(SIMISEAR),
    NATIONAL_TO_NEW_POKEDEX(PANPOUR),
    NATIONAL_TO_NEW_POKEDEX(SIMIPOUR),
    NATIONAL_TO_NEW_POKEDEX(MUNNA),
    NATIONAL_TO_NEW_POKEDEX(MUSHARNA),
    NATIONAL_TO_NEW_POKEDEX(PIDOVE),
    NATIONAL_TO_NEW_POKEDEX(TRANQUILL),
    NATIONAL_TO_NEW_POKEDEX(UNFEZANT),
    NATIONAL_TO_NEW_POKEDEX(BLITZLE),
    NATIONAL_TO_NEW_POKEDEX(ZEBSTRIKA),
    NATIONAL_TO_NEW_POKEDEX(ROGGENROLA),
    NATIONAL_TO_NEW_POKEDEX(BOLDORE),
    NATIONAL_TO_NEW_POKEDEX(GIGALITH),
    NATIONAL_TO_NEW_POKEDEX(WOOBAT),
    NATIONAL_TO_NEW_POKEDEX(SWOOBAT),
    NATIONAL_TO_NEW_POKEDEX(DRILBUR),
    NATIONAL_TO_NEW_POKEDEX(EXCADRILL),
    NATIONAL_TO_NEW_POKEDEX(AUDINO),
    NATIONAL_TO_NEW_POKEDEX(TIMBURR),
    NATIONAL_TO_NEW_POKEDEX(GURDURR),
    NATIONAL_TO_NEW_POKEDEX(CONKELDURR),
    NATIONAL_TO_NEW_POKEDEX(TYMPOLE),
    NATIONAL_TO_NEW_POKEDEX(PALPITOAD),
    NATIONAL_TO_NEW_POKEDEX(SEISMITOAD),
    NATIONAL_TO_NEW_POKEDEX(THROH),
    NATIONAL_TO_NEW_POKEDEX(SAWK),
    NATIONAL_TO_NEW_POKEDEX(SEWADDLE),
    NATIONAL_TO_NEW_POKEDEX(SWADLOON),
    NATIONAL_TO_NEW_POKEDEX(LEAVANNY),
    NATIONAL_TO_NEW_POKEDEX(VENIPEDE),
    NATIONAL_TO_NEW_POKEDEX(WHIRLIPEDE),
    NATIONAL_TO_NEW_POKEDEX(SCOLIPEDE),
    NATIONAL_TO_NEW_POKEDEX(COTTONEE),
    NATIONAL_TO_NEW_POKEDEX(WHIMSICOTT),
    NATIONAL_TO_NEW_POKEDEX(PETILIL),
    NATIONAL_TO_NEW_POKEDEX(LILLIGANT),
    NATIONAL_TO_NEW_POKEDEX(BASCULIN),
    NATIONAL_TO_NEW_POKEDEX(BASCULEGION),
    NATIONAL_TO_NEW_POKEDEX(SANDILE),
    NATIONAL_TO_NEW_POKEDEX(KROKOROK),
    NATIONAL_TO_NEW_POKEDEX(KROOKODILE),
    NATIONAL_TO_NEW_POKEDEX(DARUMAKA),
    NATIONAL_TO_NEW_POKEDEX(DARMANITAN),
    NATIONAL_TO_NEW_POKEDEX(MARACTUS),
    NATIONAL_TO_NEW_POKEDEX(DWEBBLE),
    NATIONAL_TO_NEW_POKEDEX(CRUSTLE),
    NATIONAL_TO_NEW_POKEDEX(SCRAGGY),
    NATIONAL_TO_NEW_POKEDEX(SCRAFTY),
    NATIONAL_TO_NEW_POKEDEX(SIGILYPH),
    NATIONAL_TO_NEW_POKEDEX(YAMASK),
    NATIONAL_TO_NEW_POKEDEX(COFAGRIGUS),
    NATIONAL_TO_NEW_POKEDEX(RUNERIGUS),
    NATIONAL_TO_NEW_POKEDEX(TIRTOUGA),
    NATIONAL_TO_NEW_POKEDEX(CARRACOSTA),
    NATIONAL_TO_NEW_POKEDEX(ARCHEN),
    NATIONAL_TO_NEW_POKEDEX(ARCHEOPS),
    NATIONAL_TO_NEW_POKEDEX(TRUBBISH),
    NATIONAL_TO_NEW_POKEDEX(GARBODOR),
    NATIONAL_TO_NEW_POKEDEX(ZORUA),
    NATIONAL_TO_NEW_POKEDEX(ZOROARK),
    NATIONAL_TO_NEW_POKEDEX(MINCCINO),
    NATIONAL_TO_NEW_POKEDEX(CINCCINO),
    NATIONAL_TO_NEW_POKEDEX(GOTHITA),
    NATIONAL_TO_NEW_POKEDEX(GOTHORITA),
    NATIONAL_TO_NEW_POKEDEX(GOTHITELLE),
    NATIONAL_TO_NEW_POKEDEX(SOLOSIS),
    NATIONAL_TO_NEW_POKEDEX(DUOSION),
    NATIONAL_TO_NEW_POKEDEX(REUNICLUS),
    NATIONAL_TO_NEW_POKEDEX(DUCKLETT),
    NATIONAL_TO_NEW_POKEDEX(SWANNA),
    NATIONAL_TO_NEW_POKEDEX(VANILLITE),
    NATIONAL_TO_NEW_POKEDEX(VANILLISH),
    NATIONAL_TO_NEW_POKEDEX(VANILLUXE),
    NATIONAL_TO_NEW_POKEDEX(DEERLING),
    NATIONAL_TO_NEW_POKEDEX(SAWSBUCK),
    NATIONAL_TO_NEW_POKEDEX(EMOLGA),
    NATIONAL_TO_NEW_POKEDEX(KARRABLAST),
    NATIONAL_TO_NEW_POKEDEX(ESCAVALIER),
    NATIONAL_TO_NEW_POKEDEX(FOONGUS),
    NATIONAL_TO_NEW_POKEDEX(AMOONGUSS),
    NATIONAL_TO_NEW_POKEDEX(FRILLISH),
    NATIONAL_TO_NEW_POKEDEX(JELLICENT),
    NATIONAL_TO_NEW_POKEDEX(ALOMOMOLA),
    NATIONAL_TO_NEW_POKEDEX(JOLTIK),
    NATIONAL_TO_NEW_POKEDEX(GALVANTULA),
    NATIONAL_TO_NEW_POKEDEX(FERROSEED),
    NATIONAL_TO_NEW_POKEDEX(FERROTHORN),
    NATIONAL_TO_NEW_POKEDEX(KLINK),
    NATIONAL_TO_NEW_POKEDEX(KLANG),
    NATIONAL_TO_NEW_POKEDEX(KLINKLANG),
    NATIONAL_TO_NEW_POKEDEX(TYNAMO),
    NATIONAL_TO_NEW_POKEDEX(EELEKTRIK),
    NATIONAL_TO_NEW_POKEDEX(EELEKTROSS),
    NATIONAL_TO_NEW_POKEDEX(ELGYEM),
    NATIONAL_TO_NEW_POKEDEX(BEHEEYEM),
    NATIONAL_TO_NEW_POKEDEX(LITWICK),
    NATIONAL_TO_NEW_POKEDEX(LAMPENT),
    NATIONAL_TO_NEW_POKEDEX(CHANDELURE),
    NATIONAL_TO_NEW_POKEDEX(AXEW),
    NATIONAL_TO_NEW_POKEDEX(FRAXURE),
    NATIONAL_TO_NEW_POKEDEX(HAXORUS),
    NATIONAL_TO_NEW_POKEDEX(CUBCHOO),
    NATIONAL_TO_NEW_POKEDEX(BEARTIC),
    NATIONAL_TO_NEW_POKEDEX(CRYOGONAL),
    NATIONAL_TO_NEW_POKEDEX(SHELMET),
    NATIONAL_TO_NEW_POKEDEX(ACCELGOR),
    NATIONAL_TO_NEW_POKEDEX(STUNFISK),
    NATIONAL_TO_NEW_POKEDEX(MIENFOO),
    NATIONAL_TO_NEW_POKEDEX(MIENSHAO),
    NATIONAL_TO_NEW_POKEDEX(DRUDDIGON),
    NATIONAL_TO_NEW_POKEDEX(GOLETT),
    NATIONAL_TO_NEW_POKEDEX(GOLURK),
    NATIONAL_TO_NEW_POKEDEX(PAWNIARD),
    NATIONAL_TO_NEW_POKEDEX(BISHARP),
    NATIONAL_TO_NEW_POKEDEX(KINGAMBIT),
    NATIONAL_TO_NEW_POKEDEX(BOUFFALANT),
    NATIONAL_TO_NEW_POKEDEX(RUFFLET),
    NATIONAL_TO_NEW_POKEDEX(BRAVIARY),
    NATIONAL_TO_NEW_POKEDEX(VULLABY),
    NATIONAL_TO_NEW_POKEDEX(MANDIBUZZ),
    NATIONAL_TO_NEW_POKEDEX(HEATMOR),
    NATIONAL_TO_NEW_POKEDEX(DURANT),
    NATIONAL_TO_NEW_POKEDEX(DEINO),
    NATIONAL_TO_NEW_POKEDEX(ZWEILOUS),
    NATIONAL_TO_NEW_POKEDEX(HYDREIGON),
    NATIONAL_TO_NEW_POKEDEX(LARVESTA),
    NATIONAL_TO_NEW_POKEDEX(VOLCARONA),
    NATIONAL_TO_NEW_POKEDEX(COBALION),
    NATIONAL_TO_NEW_POKEDEX(TERRAKION),
    NATIONAL_TO_NEW_POKEDEX(VIRIZION),
    NATIONAL_TO_NEW_POKEDEX(TORNADUS),
    NATIONAL_TO_NEW_POKEDEX(THUNDURUS),
    NATIONAL_TO_NEW_POKEDEX(RESHIRAM),
    NATIONAL_TO_NEW_POKEDEX(ZEKROM),
    NATIONAL_TO_NEW_POKEDEX(LANDORUS),
    NATIONAL_TO_NEW_POKEDEX(KYUREM),
    NATIONAL_TO_NEW_POKEDEX(KELDEO),
    NATIONAL_TO_NEW_POKEDEX(MELOETTA),
    NATIONAL_TO_NEW_POKEDEX(GENESECT),
    NATIONAL_TO_NEW_POKEDEX(CHESPIN),
    NATIONAL_TO_NEW_POKEDEX(QUILLADIN),
    NATIONAL_TO_NEW_POKEDEX(CHESNAUGHT),
    NATIONAL_TO_NEW_POKEDEX(FENNEKIN),
    NATIONAL_TO_NEW_POKEDEX(BRAIXEN),
    NATIONAL_TO_NEW_POKEDEX(DELPHOX),
    NATIONAL_TO_NEW_POKEDEX(FROAKIE),
    NATIONAL_TO_NEW_POKEDEX(FROGADIER),
    NATIONAL_TO_NEW_POKEDEX(GRENINJA),
    NATIONAL_TO_NEW_POKEDEX(BUNNELBY),
    NATIONAL_TO_NEW_POKEDEX(DIGGERSBY),
    NATIONAL_TO_NEW_POKEDEX(FLETCHLING),
    NATIONAL_TO_NEW_POKEDEX(FLETCHINDER),
    NATIONAL_TO_NEW_POKEDEX(TALONFLAME),
    NATIONAL_TO_NEW_POKEDEX(SCATTERBUG),
    NATIONAL_TO_NEW_POKEDEX(SPEWPA),
    NATIONAL_TO_NEW_POKEDEX(VIVILLON),
    NATIONAL_TO_NEW_POKEDEX(LITLEO),
    NATIONAL_TO_NEW_POKEDEX(PYROAR),
    NATIONAL_TO_NEW_POKEDEX(FLABEBE),
    NATIONAL_TO_NEW_POKEDEX(FLOETTE),
    NATIONAL_TO_NEW_POKEDEX(FLORGES),
    NATIONAL_TO_NEW_POKEDEX(SKIDDO),
    NATIONAL_TO_NEW_POKEDEX(GOGOAT),
    NATIONAL_TO_NEW_POKEDEX(PANCHAM),
    NATIONAL_TO_NEW_POKEDEX(PANGORO),
    NATIONAL_TO_NEW_POKEDEX(FURFROU),
    NATIONAL_TO_NEW_POKEDEX(ESPURR),
    NATIONAL_TO_NEW_POKEDEX(MEOWSTIC),
    NATIONAL_TO_NEW_POKEDEX(HONEDGE),
    NATIONAL_TO_NEW_POKEDEX(DOUBLADE),
    NATIONAL_TO_NEW_POKEDEX(AEGISLASH),
    NATIONAL_TO_NEW_POKEDEX(SPRITZEE),
    NATIONAL_TO_NEW_POKEDEX(AROMATISSE),
    NATIONAL_TO_NEW_POKEDEX(SWIRLIX),
    NATIONAL_TO_NEW_POKEDEX(SLURPUFF),
    NATIONAL_TO_NEW_POKEDEX(INKAY),
    NATIONAL_TO_NEW_POKEDEX(MALAMAR),
    NATIONAL_TO_NEW_POKEDEX(BINACLE),
    NATIONAL_TO_NEW_POKEDEX(BARBARACLE),
    NATIONAL_TO_NEW_POKEDEX(SKRELP),
    NATIONAL_TO_NEW_POKEDEX(DRAGALGE),
    NATIONAL_TO_NEW_POKEDEX(CLAUNCHER),
    NATIONAL_TO_NEW_POKEDEX(CLAWITZER),
    NATIONAL_TO_NEW_POKEDEX(HELIOPTILE),
    NATIONAL_TO_NEW_POKEDEX(HELIOLISK),
    NATIONAL_TO_NEW_POKEDEX(TYRUNT),
    NATIONAL_TO_NEW_POKEDEX(TYRANTRUM),
    NATIONAL_TO_NEW_POKEDEX(AMAURA),
    NATIONAL_TO_NEW_POKEDEX(AURORUS),
    NATIONAL_TO_NEW_POKEDEX(HAWLUCHA),
    NATIONAL_TO_NEW_POKEDEX(DEDENNE),
    NATIONAL_TO_NEW_POKEDEX(CARBINK),
    NATIONAL_TO_NEW_POKEDEX(GOOMY),
    NATIONAL_TO_NEW_POKEDEX(SLIGGOO),
    NATIONAL_TO_NEW_POKEDEX(GOODRA),
    NATIONAL_TO_NEW_POKEDEX(KLEFKI),
    NATIONAL_TO_NEW_POKEDEX(PHANTUMP),
    NATIONAL_TO_NEW_POKEDEX(TREVENANT),
    NATIONAL_TO_NEW_POKEDEX(PUMPKABOO),
    NATIONAL_TO_NEW_POKEDEX(GOURGEIST),
    NATIONAL_TO_NEW_POKEDEX(BERGMITE),
    NATIONAL_TO_NEW_POKEDEX(AVALUGG),
    NATIONAL_TO_NEW_POKEDEX(NOIBAT),
    NATIONAL_TO_NEW_POKEDEX(NOIVERN),
    NATIONAL_TO_NEW_POKEDEX(XERNEAS),
    NATIONAL_TO_NEW_POKEDEX(YVELTAL),
    NATIONAL_TO_NEW_POKEDEX(ZYGARDE),
    NATIONAL_TO_NEW_POKEDEX(DIANCIE),
    NATIONAL_TO_NEW_POKEDEX(HOOPA),
    NATIONAL_TO_NEW_POKEDEX(VOLCANION),
    NATIONAL_TO_NEW_POKEDEX(ROWLET),
    NATIONAL_TO_NEW_POKEDEX(DARTRIX),
    NATIONAL_TO_NEW_POKEDEX(DECIDUEYE),
    NATIONAL_TO_NEW_POKEDEX(LITTEN),
    NATIONAL_TO_NEW_POKEDEX(TORRACAT),
    NATIONAL_TO_NEW_POKEDEX(INCINEROAR),
    NATIONAL_TO_NEW_POKEDEX(POPPLIO),
    NATIONAL_TO_NEW_POKEDEX(BRIONNE),
    NATIONAL_TO_NEW_POKEDEX(PRIMARINA),
    NATIONAL_TO_NEW_POKEDEX(PIKIPEK),
    NATIONAL_TO_NEW_POKEDEX(TRUMBEAK),
    NATIONAL_TO_NEW_POKEDEX(TOUCANNON),
    NATIONAL_TO_NEW_POKEDEX(YUNGOOS),
    NATIONAL_TO_NEW_POKEDEX(GUMSHOOS),
    NATIONAL_TO_NEW_POKEDEX(GRUBBIN),
    NATIONAL_TO_NEW_POKEDEX(CHARJABUG),
    NATIONAL_TO_NEW_POKEDEX(VIKAVOLT),
    NATIONAL_TO_NEW_POKEDEX(CRABRAWLER),
    NATIONAL_TO_NEW_POKEDEX(CRABOMINABLE),
    NATIONAL_TO_NEW_POKEDEX(ORICORIO),
    NATIONAL_TO_NEW_POKEDEX(CUTIEFLY),
    NATIONAL_TO_NEW_POKEDEX(RIBOMBEE),
    NATIONAL_TO_NEW_POKEDEX(ROCKRUFF),
    NATIONAL_TO_NEW_POKEDEX(LYCANROC),
    NATIONAL_TO_NEW_POKEDEX(WISHIWASHI),
    NATIONAL_TO_NEW_POKEDEX(MAREANIE),
    NATIONAL_TO_NEW_POKEDEX(TOXAPEX),
    NATIONAL_TO_NEW_POKEDEX(MUDBRAY),
    NATIONAL_TO_NEW_POKEDEX(MUDSDALE),
    NATIONAL_TO_NEW_POKEDEX(DEWPIDER),
    NATIONAL_TO_NEW_POKEDEX(ARAQUANID),
    NATIONAL_TO_NEW_POKEDEX(FOMANTIS),
    NATIONAL_TO_NEW_POKEDEX(LURANTIS),
    NATIONAL_TO_NEW_POKEDEX(MORELULL),
    NATIONAL_TO_NEW_POKEDEX(SHIINOTIC),
    NATIONAL_TO_NEW_POKEDEX(SALANDIT),
    NATIONAL_TO_NEW_POKEDEX(SALAZZLE),
    NATIONAL_TO_NEW_POKEDEX(STUFFUL),
    NATIONAL_TO_NEW_POKEDEX(BEWEAR),
    NATIONAL_TO_NEW_POKEDEX(BOUNSWEET),
    NATIONAL_TO_NEW_POKEDEX(STEENEE),
    NATIONAL_TO_NEW_POKEDEX(TSAREENA),
    NATIONAL_TO_NEW_POKEDEX(COMFEY),
    NATIONAL_TO_NEW_POKEDEX(ORANGURU),
    NATIONAL_TO_NEW_POKEDEX(PASSIMIAN),
    NATIONAL_TO_NEW_POKEDEX(WIMPOD),
    NATIONAL_TO_NEW_POKEDEX(GOLISOPOD),
    NATIONAL_TO_NEW_POKEDEX(SANDYGAST),
    NATIONAL_TO_NEW_POKEDEX(PALOSSAND),
    NATIONAL_TO_NEW_POKEDEX(PYUKUMUKU),
    NATIONAL_TO_NEW_POKEDEX(TYPE_NULL),
    NATIONAL_TO_NEW_POKEDEX(SILVALLY),
    NATIONAL_TO_NEW_POKEDEX(MINIOR),
    NATIONAL_TO_NEW_POKEDEX(KOMALA),
    NATIONAL_TO_NEW_POKEDEX(TURTONATOR),
    NATIONAL_TO_NEW_POKEDEX(TOGEDEMARU),
    NATIONAL_TO_NEW_POKEDEX(MIMIKYU),
    NATIONAL_TO_NEW_POKEDEX(BRUXISH),
    NATIONAL_TO_NEW_POKEDEX(DRAMPA),
    NATIONAL_TO_NEW_POKEDEX(DHELMISE),
    NATIONAL_TO_NEW_POKEDEX(JANGMO_O),
    NATIONAL_TO_NEW_POKEDEX(HAKAMO_O),
    NATIONAL_TO_NEW_POKEDEX(KOMMO_O),
    NATIONAL_TO_NEW_POKEDEX(TAPU_KOKO),
    NATIONAL_TO_NEW_POKEDEX(TAPU_LELE),
    NATIONAL_TO_NEW_POKEDEX(TAPU_BULU),
    NATIONAL_TO_NEW_POKEDEX(TAPU_FINI),
    NATIONAL_TO_NEW_POKEDEX(COSMOG),
    NATIONAL_TO_NEW_POKEDEX(COSMOEM),
    NATIONAL_TO_NEW_POKEDEX(SOLGALEO),
    NATIONAL_TO_NEW_POKEDEX(LUNALA),
    NATIONAL_TO_NEW_POKEDEX(NIHILEGO),
    NATIONAL_TO_NEW_POKEDEX(BUZZWOLE),
    NATIONAL_TO_NEW_POKEDEX(PHEROMOSA),
    NATIONAL_TO_NEW_POKEDEX(XURKITREE),
    NATIONAL_TO_NEW_POKEDEX(CELESTEELA),
    NATIONAL_TO_NEW_POKEDEX(KARTANA),
    NATIONAL_TO_NEW_POKEDEX(GUZZLORD),
    NATIONAL_TO_NEW_POKEDEX(NECROZMA),
    NATIONAL_TO_NEW_POKEDEX(MAGEARNA),
    NATIONAL_TO_NEW_POKEDEX(MARSHADOW),
    NATIONAL_TO_NEW_POKEDEX(POIPOLE),
    NATIONAL_TO_NEW_POKEDEX(NAGANADEL),
    NATIONAL_TO_NEW_POKEDEX(STAKATAKA),
    NATIONAL_TO_NEW_POKEDEX(BLACEPHALON),
    NATIONAL_TO_NEW_POKEDEX(ZERAORA),
    NATIONAL_TO_NEW_POKEDEX(MELTAN),
    NATIONAL_TO_NEW_POKEDEX(MELMETAL),
    NATIONAL_TO_NEW_POKEDEX(GROOKEY),
    NATIONAL_TO_NEW_POKEDEX(THWACKEY),
    NATIONAL_TO_NEW_POKEDEX(RILLABOOM),
    NATIONAL_TO_NEW_POKEDEX(SCORBUNNY),
    NATIONAL_TO_NEW_POKEDEX(RABOOT),
    NATIONAL_TO_NEW_POKEDEX(CINDERACE),
    NATIONAL_TO_NEW_POKEDEX(SOBBLE),
    NATIONAL_TO_NEW_POKEDEX(DRIZZILE),
    NATIONAL_TO_NEW_POKEDEX(INTELEON),
    NATIONAL_TO_NEW_POKEDEX(SKWOVET),
    NATIONAL_TO_NEW_POKEDEX(GREEDENT),
    NATIONAL_TO_NEW_POKEDEX(ROOKIDEE),
    NATIONAL_TO_NEW_POKEDEX(CORVISQUIRE),
    NATIONAL_TO_NEW_POKEDEX(CORVIKNIGHT),
    NATIONAL_TO_NEW_POKEDEX(BLIPBUG),
    NATIONAL_TO_NEW_POKEDEX(DOTTLER),
    NATIONAL_TO_NEW_POKEDEX(ORBEETLE),
    NATIONAL_TO_NEW_POKEDEX(NICKIT),
    NATIONAL_TO_NEW_POKEDEX(THIEVUL),
    NATIONAL_TO_NEW_POKEDEX(GOSSIFLEUR),
    NATIONAL_TO_NEW_POKEDEX(ELDEGOSS),
    NATIONAL_TO_NEW_POKEDEX(WOOLOO),
    NATIONAL_TO_NEW_POKEDEX(DUBWOOL),
    NATIONAL_TO_NEW_POKEDEX(CHEWTLE),
    NATIONAL_TO_NEW_POKEDEX(DREDNAW),
    NATIONAL_TO_NEW_POKEDEX(YAMPER),
    NATIONAL_TO_NEW_POKEDEX(BOLTUND),
    NATIONAL_TO_NEW_POKEDEX(ROLYCOLY),
    NATIONAL_TO_NEW_POKEDEX(CARKOL),
    NATIONAL_TO_NEW_POKEDEX(COALOSSAL),
    NATIONAL_TO_NEW_POKEDEX(APPLIN),
    NATIONAL_TO_NEW_POKEDEX(FLAPPLE),
    NATIONAL_TO_NEW_POKEDEX(APPLETUN),
    NATIONAL_TO_NEW_POKEDEX(DIPPLIN),
    NATIONAL_TO_NEW_POKEDEX(HYDRAPPLE),
    NATIONAL_TO_NEW_POKEDEX(SILICOBRA),
    NATIONAL_TO_NEW_POKEDEX(SANDACONDA),
    NATIONAL_TO_NEW_POKEDEX(CRAMORANT),
    NATIONAL_TO_NEW_POKEDEX(ARROKUDA),
    NATIONAL_TO_NEW_POKEDEX(BARRASKEWDA),
    NATIONAL_TO_NEW_POKEDEX(TOXEL),
    NATIONAL_TO_NEW_POKEDEX(TOXTRICITY),
    NATIONAL_TO_NEW_POKEDEX(SIZZLIPEDE),
    NATIONAL_TO_NEW_POKEDEX(CENTISKORCH),
    NATIONAL_TO_NEW_POKEDEX(CLOBBOPUS),
    NATIONAL_TO_NEW_POKEDEX(GRAPPLOCT),
    NATIONAL_TO_NEW_POKEDEX(SINISTEA),
    NATIONAL_TO_NEW_POKEDEX(POLTEAGEIST),
    NATIONAL_TO_NEW_POKEDEX(HATENNA),
    NATIONAL_TO_NEW_POKEDEX(HATTREM),
    NATIONAL_TO_NEW_POKEDEX(HATTERENE),
    NATIONAL_TO_NEW_POKEDEX(IMPIDIMP),
    NATIONAL_TO_NEW_POKEDEX(MORGREM),
    NATIONAL_TO_NEW_POKEDEX(GRIMMSNARL),
    NATIONAL_TO_NEW_POKEDEX(MILCERY),
    NATIONAL_TO_NEW_POKEDEX(ALCREMIE),
    NATIONAL_TO_NEW_POKEDEX(FALINKS),
    NATIONAL_TO_NEW_POKEDEX(PINCURCHIN),
    NATIONAL_TO_NEW_POKEDEX(SNOM),
    NATIONAL_TO_NEW_POKEDEX(FROSMOTH),
    NATIONAL_TO_NEW_POKEDEX(STONJOURNER),
    NATIONAL_TO_NEW_POKEDEX(EISCUE),
    NATIONAL_TO_NEW_POKEDEX(INDEEDEE),
    NATIONAL_TO_NEW_POKEDEX(MORPEKO),
    NATIONAL_TO_NEW_POKEDEX(CUFANT),
    NATIONAL_TO_NEW_POKEDEX(COPPERAJAH),
    NATIONAL_TO_NEW_POKEDEX(DRACOZOLT),
    NATIONAL_TO_NEW_POKEDEX(ARCTOZOLT),
    NATIONAL_TO_NEW_POKEDEX(DRACOVISH),
    NATIONAL_TO_NEW_POKEDEX(ARCTOVISH),
    NATIONAL_TO_NEW_POKEDEX(DURALUDON),
    NATIONAL_TO_NEW_POKEDEX(ARCHALUDON),
    NATIONAL_TO_NEW_POKEDEX(DREEPY),
    NATIONAL_TO_NEW_POKEDEX(DRAKLOAK),
    NATIONAL_TO_NEW_POKEDEX(DRAGAPULT),
    NATIONAL_TO_NEW_POKEDEX(ZACIAN),
    NATIONAL_TO_NEW_POKEDEX(ZAMAZENTA),
    NATIONAL_TO_NEW_POKEDEX(ETERNATUS),
    NATIONAL_TO_NEW_POKEDEX(KUBFU),
    NATIONAL_TO_NEW_POKEDEX(URSHIFU),
    NATIONAL_TO_NEW_POKEDEX(ZARUDE),
    NATIONAL_TO_NEW_POKEDEX(REGIELEKI),
    NATIONAL_TO_NEW_POKEDEX(REGIDRAGO),
    NATIONAL_TO_NEW_POKEDEX(GLASTRIER),
    NATIONAL_TO_NEW_POKEDEX(SPECTRIER),
    NATIONAL_TO_NEW_POKEDEX(CALYREX),
    NATIONAL_TO_NEW_POKEDEX(ENAMORUS),
    NATIONAL_TO_NEW_POKEDEX(SPRIGATITO),
    NATIONAL_TO_NEW_POKEDEX(FLORAGATO),
    NATIONAL_TO_NEW_POKEDEX(MEOWSCARADA),
    NATIONAL_TO_NEW_POKEDEX(FUECOCO),
    NATIONAL_TO_NEW_POKEDEX(CROCALOR),
    NATIONAL_TO_NEW_POKEDEX(SKELEDIRGE),
    NATIONAL_TO_NEW_POKEDEX(QUAXLY),
    NATIONAL_TO_NEW_POKEDEX(QUAXWELL),
    NATIONAL_TO_NEW_POKEDEX(QUAQUAVAL),
    NATIONAL_TO_NEW_POKEDEX(LECHONK),
    NATIONAL_TO_NEW_POKEDEX(OINKOLOGNE),
    NATIONAL_TO_NEW_POKEDEX(TAROUNTULA),
    NATIONAL_TO_NEW_POKEDEX(SPIDOPS),
    NATIONAL_TO_NEW_POKEDEX(NYMBLE),
    NATIONAL_TO_NEW_POKEDEX(LOKIX),
    NATIONAL_TO_NEW_POKEDEX(PAWMI),
    NATIONAL_TO_NEW_POKEDEX(PAWMO),
    NATIONAL_TO_NEW_POKEDEX(PAWMOT),
    NATIONAL_TO_NEW_POKEDEX(TANDEMAUS),
    NATIONAL_TO_NEW_POKEDEX(MAUSHOLD),
    NATIONAL_TO_NEW_POKEDEX(FIDOUGH),
    NATIONAL_TO_NEW_POKEDEX(DACHSBUN),
    NATIONAL_TO_NEW_POKEDEX(SMOLIV),
    NATIONAL_TO_NEW_POKEDEX(DOLLIV),
    NATIONAL_TO_NEW_POKEDEX(ARBOLIVA),
    NATIONAL_TO_NEW_POKEDEX(SQUAWKABILLY),
    NATIONAL_TO_NEW_POKEDEX(NACLI),
    NATIONAL_TO_NEW_POKEDEX(NACLSTACK),
    NATIONAL_TO_NEW_POKEDEX(GARGANACL),
    NATIONAL_TO_NEW_POKEDEX(CHARCADET),
    NATIONAL_TO_NEW_POKEDEX(ARMAROUGE),
    NATIONAL_TO_NEW_POKEDEX(CERULEDGE),
    NATIONAL_TO_NEW_POKEDEX(TADBULB),
    NATIONAL_TO_NEW_POKEDEX(BELLIBOLT),
    NATIONAL_TO_NEW_POKEDEX(WATTREL),
    NATIONAL_TO_NEW_POKEDEX(KILOWATTREL),
    NATIONAL_TO_NEW_POKEDEX(MASCHIFF),
    NATIONAL_TO_NEW_POKEDEX(MABOSSTIFF),
    NATIONAL_TO_NEW_POKEDEX(SHROODLE),
    NATIONAL_TO_NEW_POKEDEX(GRAFAIAI),
    NATIONAL_TO_NEW_POKEDEX(BRAMBLIN),
    NATIONAL_TO_NEW_POKEDEX(BRAMBLEGHAST),
    NATIONAL_TO_NEW_POKEDEX(TOEDSCOOL),
    NATIONAL_TO_NEW_POKEDEX(TOEDSCRUEL),
    NATIONAL_TO_NEW_POKEDEX(KLAWF),
    NATIONAL_TO_NEW_POKEDEX(CAPSAKID),
    NATIONAL_TO_NEW_POKEDEX(SCOVILLAIN),
    NATIONAL_TO_NEW_POKEDEX(RELLOR),
    NATIONAL_TO_NEW_POKEDEX(RABSCA),
    NATIONAL_TO_NEW_POKEDEX(FLITTLE),
    NATIONAL_TO_NEW_POKEDEX(ESPATHRA),
    NATIONAL_TO_NEW_POKEDEX(TINKATINK),
    NATIONAL_TO_NEW_POKEDEX(TINKATUFF),
    NATIONAL_TO_NEW_POKEDEX(TINKATON),
    NATIONAL_TO_NEW_POKEDEX(WIGLETT),
    NATIONAL_TO_NEW_POKEDEX(WUGTRIO),
    NATIONAL_TO_NEW_POKEDEX(BOMBIRDIER),
    NATIONAL_TO_NEW_POKEDEX(FINIZEN),
    NATIONAL_TO_NEW_POKEDEX(PALAFIN),
    NATIONAL_TO_NEW_POKEDEX(VAROOM),
    NATIONAL_TO_NEW_POKEDEX(REVAVROOM),
    NATIONAL_TO_NEW_POKEDEX(CYCLIZAR),
    NATIONAL_TO_NEW_POKEDEX(ORTHWORM),
    NATIONAL_TO_NEW_POKEDEX(GLIMMET),
    NATIONAL_TO_NEW_POKEDEX(GLIMMORA),
    NATIONAL_TO_NEW_POKEDEX(GREAVARD),
    NATIONAL_TO_NEW_POKEDEX(HOUNDSTONE),
    NATIONAL_TO_NEW_POKEDEX(FLAMIGO),
    NATIONAL_TO_NEW_POKEDEX(CETODDLE),
    NATIONAL_TO_NEW_POKEDEX(CETITAN),
    NATIONAL_TO_NEW_POKEDEX(VELUZA),
    NATIONAL_TO_NEW_POKEDEX(DONDOZO),
    NATIONAL_TO_NEW_POKEDEX(TATSUGIRI),
    NATIONAL_TO_NEW_POKEDEX(GREAT_TUSK),
    NATIONAL_TO_NEW_POKEDEX(SCREAM_TAIL),
    NATIONAL_TO_NEW_POKEDEX(BRUTE_BONNET),
    NATIONAL_TO_NEW_POKEDEX(FLUTTER_MANE),
    NATIONAL_TO_NEW_POKEDEX(SLITHER_WING),
    NATIONAL_TO_NEW_POKEDEX(SANDY_SHOCKS),
    NATIONAL_TO_NEW_POKEDEX(IRON_TREADS),
    NATIONAL_TO_NEW_POKEDEX(IRON_BUNDLE),
    NATIONAL_TO_NEW_POKEDEX(IRON_HANDS),
    NATIONAL_TO_NEW_POKEDEX(IRON_JUGULIS),
    NATIONAL_TO_NEW_POKEDEX(IRON_MOTH),
    NATIONAL_TO_NEW_POKEDEX(IRON_THORNS),
    NATIONAL_TO_NEW_POKEDEX(FRIGIBAX),
    NATIONAL_TO_NEW_POKEDEX(ARCTIBAX),
    NATIONAL_TO_NEW_POKEDEX(BAXCALIBUR),
    NATIONAL_TO_NEW_POKEDEX(GIMMIGHOUL),
    NATIONAL_TO_NEW_POKEDEX(GHOLDENGO),
    NATIONAL_TO_NEW_POKEDEX(WO_CHIEN),
    NATIONAL_TO_NEW_POKEDEX(CHIEN_PAO),
    NATIONAL_TO_NEW_POKEDEX(TING_LU),
    NATIONAL_TO_NEW_POKEDEX(CHI_YU),
    NATIONAL_TO_NEW_POKEDEX(ROARING_MOON),
    NATIONAL_TO_NEW_POKEDEX(IRON_VALIANT),
    NATIONAL_TO_NEW_POKEDEX(KORAIDON),
    NATIONAL_TO_NEW_POKEDEX(MIRAIDON),
    NATIONAL_TO_NEW_POKEDEX(WALKING_WAKE),
    NATIONAL_TO_NEW_POKEDEX(IRON_LEAVES),
    NATIONAL_TO_NEW_POKEDEX(POLTCHAGEIST),
    NATIONAL_TO_NEW_POKEDEX(SINISTCHA),
    NATIONAL_TO_NEW_POKEDEX(OKIDOGI),
    NATIONAL_TO_NEW_POKEDEX(MUNKIDORI),
    NATIONAL_TO_NEW_POKEDEX(FEZANDIPITI),
    NATIONAL_TO_NEW_POKEDEX(OGERPON),
    NATIONAL_TO_NEW_POKEDEX(GOUGING_FIRE),
    NATIONAL_TO_NEW_POKEDEX(RAGING_BOLT),
    NATIONAL_TO_NEW_POKEDEX(IRON_BOULDER),
    NATIONAL_TO_NEW_POKEDEX(IRON_CROWN),
    NATIONAL_TO_NEW_POKEDEX(TERAPAGOS),
    NATIONAL_TO_NEW_POKEDEX(PECHARUNT),
};
...
u32 NationalToNewPokedexOrder(u32 nationalNum)
{
    ...
    while (newNum < (NEW_POKEDEX_COUNT - 1) && sNewPokedexToNationalOrder[newNum] != nationalNum)
        newNum++;

    if (newNum > NEW_POKEDEX_COUNT - 1)
        return 0;
...
{
    if (!newNum || newNum > NEW_POKEDEX_COUNT)
        return 0;

    return sNewPokedexToNationalOrder[newNum - 1];
}
