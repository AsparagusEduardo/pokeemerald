...
static void DexScreen_InitListMenuForOrderedList(struct ListMenuTemplate * template, u8 order);
...
void DexScreen_PrintMonHeight(u8 windowId, u16 species, u8 x, u8 y)
{
    ...
    DexScreen_AddTextPrinterParameterized(windowId, FONT_SMALL, gText_HTHeight, x, y, 0);
    x += 30;
...
void DexScreen_PrintMonWeight(u8 windowId, u16 species, u8 x, u8 y)
{
    ...
    DexScreen_AddTextPrinterParameterized(windowId, FONT_SMALL, gText_WTWeight, x, y, 0);
    x += 30;
...
u8 DexScreen_RegisterMonToPokedexFRLG(u16 species)
{
