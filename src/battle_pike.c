...
#elif ITALIAN
    {EC_WORD_WHOM, EC_WORD_ARE, EC_WORD_LOST, EC_WORD_ELLIPSIS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_AS_IF, EC_WORD_RUN, EC_WORD_EVEN_SO, EC_WORD_ARE, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_NOW, EC_WORD_THING, EC_WORD_GIVE, EC_WORD_QUES, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_HERE, EC_WORD_ON, EC_WORD_IS, EC_WORD_INCREDIBLE, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_WILL, EC_WORD_SAYS, EC_WORD_A, EC_WORD_LOSER, EC_WORD_TODAY, EC_WORD_QUES},
    {EC_WORD_AS_IF, EC_WORD_WHOM, EC_WORD_LIKES, EC_WORD_WHEN, EC_WORD_UNDERSTOOD, EC_WORD_ELLIPSIS},
    {EC_WORD_UNDERSTOOD, EC_WORD_AS_IF, EC_WORD_IS, EC_WORD_AS, EC_WORD_NICE, EC_WORD_ELLIPSIS},
    {EC_WORD_AS_IF, EC_WORD_IS, EC_WORD_THOSE_WERE, EC_WORD_OFF, EC_WORD_CHALLENGE, EC_WORD_ELLIPSIS},
    {EC_WORD_ARE, EC_WORD_LOWS, EC_WORD_A, EC_WORD_DRAGON, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_GO, EC_WORD_EXCL, EC_WORD_IS, EC_WORD_ONLY, EC_WORD_TO, EC_MOVE2(TAUNT)},
    {EC_WORD_BUT, EC_WORD_WONDER, EC_WORD_WILL_BE_HERE, EC_WORD_QUES, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_IS, EC_WORD_IMPORTANT, EC_WORD_CONCEDE, EC_WORD_SCATTER, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_AND, EC_WORD_IF, EC_WORD_LOSE, EC_WORD_ELLIPSIS, EC_MOVE(BIDE), EC_WORD_ELLIPSIS},
    {EC_WORD_AND, EC_WORD_NOW, EC_WORD_THING, EC_WORD_PLEASE, EC_WORD_MAKE, EC_WORD_QUES},
    {EC_WORD_PLEASE, EC_WORD_IF_I_WIN, EC_WORD_ALWAYS, EC_WORD_ELLIPSIS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_WHOM, EC_WORD_CHANGE, EC_WORD_TAKE_THAT, EC_WORD_QUES_EXCL, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_DISASTER, EC_WORD_ABOUT, EC_WORD_FIGHTS, EC_WORD_ELLIPSIS_ELLIPSIS_ELLIPSIS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_AS_IF, EC_WORD_OVER, EC_WORD_PLEASE, EC_WORD_PERFECT, EC_WORD_PLUS, EC_WORD_ELLIPSIS},
    {EC_WORD_AS_IF, EC_WORD_RUN, EC_WORD_IF, EC_WORD_IS, EC_WORD_OKAY, EC_WORD_ELLIPSIS},
    {EC_WORD_OH, EC_WORD_NO, EC_WORD_AS_IF, EC_WORD_A, EC_WORD_THIS, EC_WORD_TRAINER},
    {EC_WORD_SHOW, EC_WORD_CONCEDE, EC_WORD_WEREN_T, EC_WORD_ANOTHER, EC_WORD_MEAN, EC_WORD_LEFT},
    {EC_WORD_OR, EC_WORD_THAT_S, EC_WORD_ANY, EC_WORD_FINAL, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_IS, EC_WORD_A, EC_WORD_TRENDY, EC_WORD_FROM, EC_WORD_RIVAL, EC_WORD_QUES},
    {EC_WORD_WHOM, EC_WORD_OK_QUES, EC_WORD_COME, EC_WORD_TO, EC_WORD_SILKY, EC_MOVE2(REFRESH)},
    {EC_WORD_GIVE, EC_WORD_LISTEN, EC_WORD_HERE, EC_WORD_NITWIT, EC_WORD_IF_I_WIN, EC_WORD_ELLIPSIS},
    {EC_WORD_AS_IF, EC_WORD_PLEASE, EC_WORD_IF_I_WIN, EC_WORD_ELLIPSIS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_REFUSE, EC_WORD_GO_AHEAD, EC_WORD_LET_S, EC_WORD_ELLIPSIS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_TRAINER, EC_WORD_LATER, EC_WORD_TRAINER, EC_WORD_ELLIPSIS, EC_WORD_MISS, EC_WORD_WANTS},
    {EC_WORD_WHICH, EC_WORD_NEVER, EC_WORD_ALL, EC_WORD_POKEMON, EC_WORD_STEEL, EC_WORD_QUES},
    {EC_WORD_UNDERSTOOD, EC_WORD_ARE, EC_WORD_LOWS, EC_WORD_EASY, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_AS_IF, EC_WORD_IS, EC_WORD_HERE, EC_WORD_OKAY, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_AND, EC_WORD_NOW, EC_WORD_THING, EC_WORD_PLEASE, EC_WORD_MAKE, EC_WORD_QUES},
    {EC_WORD_ARE, EC_WORD_ONLY, EC_WORD_A, EC_WORD_A_TINY_BIT, EC_WORD_SPIRALING, EC_WORD_ELLIPSIS},
    {EC_WORD_TRAINS, EC_WORD_ONLY, EC_WORD_ALLOW, EC_WORD_MEAN, EC_WORD_HOME, EC_WORD_ELLIPSIS},
    {EC_WORD_WOW, EC_WORD_ELLIPSIS_ELLIPSIS_ELLIPSIS, EC_WORD_UNDERSTOOD, EC_WORD_IS, EC_WORD_HERE, EC_WORD_EXCITING},
    {EC_WORD_AS_IF, EC_WORD_IS_IT_QUES, EC_WORD_MUST_BE, EC_WORD_TEACHES, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_SHOW, EC_WORD_CONCEDE, EC_WORD_WEREN_T, EC_WORD_ANOTHER, EC_WORD_MEAN, EC_WORD_RIGHT},
    {EC_WORD_AS_IF, EC_WORD_IS, EC_WORD_NITWIT, EC_WORD_LISTEN, EC_WORD_UNDERSTOOD, EC_WORD_ELLIPSIS},
    {EC_WORD_ALL, EC_WORD_TOO, EC_WORD_POKEMON, EC_WORD_ARE, EC_WORD_GOT, EC_WORD_ELLIPSIS},
    {EC_WORD_IS_IT_QUES, EC_WORD_POKEMON, EC_WORD_TOO_STRONG, EC_WORD_VERSUS, EC_WORD_POISON, EC_WORD_ELLIPSIS},
    {EC_WORD_HOW, EC_WORD_ARE, EC_WORD_SILKY, EC_WORD_WEREN_T, EC_WORD_WEREN_T, EC_WORD_WEREN_T},
    {EC_WORD_TO, EC_MOVE2(TOXIC), EC_WORD_WHOM, EC_WORD_CHANGE, EC_WORD_MAKE, EC_WORD_FEAR},
#elif SPANISH
    {EC_WORD_ARRGH, EC_WORD_ARRGH, EC_WORD_A, EC_MOVE2(HELPING_HAND), EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_WHERE, EC_WORD_DOES, EC_WORD_DOWN, EC_WORD_IS, EC_WORD_THIS, EC_EMPTY_WORD},
    {EC_WORD_WHERE, EC_WORD_DOES, EC_WORD_DOWN, EC_WORD_BELONGS_TO, EC_WORD_HERE, EC_EMPTY_WORD},
    {EC_WORD_THIS, EC_WORD_ABSOLUTELY, EC_WORD_WITHOUT, EC_WORD_QUITE, EC_WORD_THAT, EC_EMPTY_WORD},
    {EC_WORD_QUES_EXCL, EC_WORD_LAY, EC_WORD_WITHOUT, EC_WORD_QUITE, EC_WORD_THAT, EC_WORD_QUES},
    {EC_WORD_THIS, EC_WORD_ABSOLUTELY, EC_WORD_WITHOUT, EC_WORD_A_LITTLE, EC_WORD_LIE, EC_WORD_HAS},
    {EC_WORD_WILL_BE_HERE, EC_WORD_IMPORTANT, EC_WORD_LIE, EC_WORD_THIS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_ABSOLUTELY, EC_WORD_LIKE, EC_WORD_A_TINY_BIT, EC_WORD_CHALLENGE, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_ABSOLUTELY, EC_WORD_LIKE, EC_WORD_A_TINY_BIT, EC_MOVE2(TACKLE), EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_HAVE, EC_WORD_PROBABLY, EC_WORD_LIE, EC_WORD_LOSS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_QUES_EXCL, EC_WORD_BUT, EC_WORD_WHO, EC_WORD_LET_S, EC_WORD_YOU, EC_WORD_QUES},
    {EC_WORD_WILL_BE_HERE, EC_WORD_TRY, EC_WORD_CHOICE, EC_EMPTY_WORD, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_CHOICE, EC_WORD_WHERE, EC_WORD_SINCE, EC_WORD_FIGHTS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_AND, EC_WORD_NOW, EC_WORD_HUH_QUES, EC_EMPTY_WORD, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_MISS, EC_MOVE(SHEER_COLD), EC_WORD_CAN, EC_WORD_WIN, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_ABSOLUTELY, EC_WORD_IT, EC_WORD_ONLY, EC_WORD_LATE, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_FIGHTS, EC_WORD_IS, EC_WORD_LEFT, EC_WORD_INCREDIBLE, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_I, EC_WORD_CHOICE, EC_WORD_WHERE, EC_WORD_CAN, EC_WORD_PLUS, EC_EMPTY_WORD},
    {EC_WORD_WHERE, EC_WORD_DOES, EC_WORD_DOWN, EC_WORD_DON_T, EC_WORD_THING, EC_EMPTY_WORD},
    {EC_WORD_WHERE, EC_WORD_SINCE, EC_WORD_FORGETS, EC_WORD_PLUS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_LEFT, EC_WORD_WHOM, EC_WORD_NATURALLY, EC_WORD_LOLLING, EC_WORD_LIMBER, EC_EMPTY_WORD},
    {EC_WORD_SINCE, EC_WORD_STOP, EC_WORD_SOON, EC_WORD_MISS, EC_WORD_CASE, EC_WORD_THIS},
    {EC_WORD_DOWN, EC_WORD_WEAKENED, EC_WORD_IS, EC_WORD_CASE, EC_WORD_OH_QUES, EC_EMPTY_WORD},
    {EC_WORD_OR, EC_WORD_LISTEN, EC_WORD_USING, EC_WORD_TRULY, EC_WORD_JUST, EC_WORD_STRONG},
    {EC_WORD_I, EC_WORD_WHERE, EC_WORD_SURRENDER, EC_WORD_FOREVER, EC_WORD_ANOTHER, EC_EMPTY_WORD},
    {EC_WORD_I, EC_WORD_WHERE, EC_WORD_WHOM, EC_WORD_PLUS, EC_WORD_WHEN_I_WIN, EC_EMPTY_WORD},
    {EC_WORD_LIE, EC_WORD_THESE_WERE, EC_WORD_NITWIT, EC_WORD_WHERE, EC_WORD_CAN, EC_WORD_PLUS},
    {EC_WORD_SINCE, EC_WORD_FOR_NOW, EC_MOVE2(REST), EC_EMPTY_WORD, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_QUES_EXCL, EC_WORD_LAY, EC_WORD_LIKE, EC_WORD_A_TINY_BIT, EC_WORD_STEEL, EC_WORD_QUES},
    {EC_WORD_HERE, EC_WORD_WHERE, EC_WORD_BELONGS_TO, EC_WORD_LEVEL, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_THIS, EC_WORD_IS, EC_WORD_HOPELESS, EC_WORD_LIE, EC_WORD_THESE_WERE, EC_EMPTY_WORD},
    {EC_WORD_OR, EC_WORD_LISTEN, EC_WORD_USING, EC_WORD_AROUND, EC_WORD_NITWIT, EC_WORD_DOES},
    {EC_WORD_EXCL_EXCL, EC_WORD_DOWN, EC_WORD_LOLLING, EC_MOVE2(CONFUSION), EC_WORD_WHOM, EC_WORD_EXCL},
    {EC_WORD_WHERE, EC_WORD_SINCE, EC_WORD_FIGHTS, EC_WORD_PLUS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_WILL_BE_HERE, EC_WORD_HERE, EC_WORD_RECOMMEND, EC_WORD_PUSHOVER, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_WHERE, EC_WORD_WHOM, EC_WORD_ME, EC_WORD_THIS_IS_IT_EXCL, EC_WORD_THE, EC_WORD_THIS},
    {EC_WORD_A, EC_WORD_BELIEVE, EC_WORD_EARLIER, EC_WORD_LIE, EC_WORD_FIGHTS, EC_EMPTY_WORD},
    {EC_WORD_ARRGH, EC_WORD_AVANT_GARDE, EC_WORD_SIGH, EC_EMPTY_WORD, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_TOO_LATE, EC_WORD_POKEMON, EC_WORD_WAS, EC_WORD_REAR, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_TOO_LATE, EC_WORD_POKEMON, EC_WORD_WAS, EC_WORD_FULL, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_HIYAH, EC_WORD_HIYAH, EC_WORD_WAY, EC_WORD_WAY, EC_WORD_HIYAH, EC_WORD_HIYAH},
    {EC_WORD_A_TINY_BIT, EC_WORD_POISON, EC_WORD_IS, EC_WORD_A_LITTLE, EC_WORD_HOPELESS, EC_EMPTY_WORD},
#elif GERMAN
