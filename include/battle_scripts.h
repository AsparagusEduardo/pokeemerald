...
extern const u8 BattleScript_MirrorHerbCopyStatChangeEnd[];
...
extern const u8 BattleScript_BerryCureBrnEnd[];
extern const u8 BattleScript_BerryCureBrnRet[];
extern const u8 BattleScript_BerryCureFrzEnd[];
extern const u8 BattleScript_BerryCureFrzRet[];
extern const u8 BattleScript_BerryCureFrbEnd[];
extern const u8 BattleScript_BerryCureFrbRet[];
extern const u8 BattleScript_BerryCureSlpEnd[];
extern const u8 BattleScript_BerryCureSlpRet[];
extern const u8 BattleScript_BerryCureConfusionEnd[];
extern const u8 BattleScript_BerryCureConfusionRet[];
extern const u8 BattleScript_BerryCureChosenStatusEnd[];
extern const u8 BattleScript_BerryCureChosenStatusRet[];
extern const u8 BattleScript_WhiteHerbEnd[];
extern const u8 BattleScript_WhiteHerbRet[];
extern const u8 BattleScript_ItemHealHP_RemoveItemRet[];
extern const u8 BattleScript_ItemHealHP_RemoveItemEnd[];
extern const u8 BattleScript_BerryPPHealEnd[];
extern const u8 BattleScript_BerryPPHealRet[];
extern const u8 BattleScript_ItemHealHP_End[];
...
extern const u8 BattleScript_BerryConfuseHealEnd[];
extern const u8 BattleScript_BerryConfuseHealRet[];
extern const u8 BattleScript_BerryStatRaiseEnd[];
extern const u8 BattleScript_BerryStatRaiseRet[];
extern const u8 BattleScript_BerryFocusEnergyRet[];
extern const u8 BattleScript_BerryFocusEnergyEnd[];
...
extern const u8 BattleScript_AttackerAbilityStatRaiseEnd[];
...
extern const u8 BattleScript_ItemHurtEnd[];
...
extern const u8 BattleScript_AttackerFormChangeEnd[];
extern const u8 BattleScript_AttackerFormChangeWithString[];
extern const u8 BattleScript_AttackerFormChangeWithStringEnd[];
...
extern const u8 BattleScript_MicleBerryActivateEnd[];
...
extern const u8 BattleScript_EjectPackActivate_End[];
...
extern const u8 BattleScript_MentalHerbCureEnd[];
extern const u8 BattleScript_TerrainPreventsEnd[];
...
extern const u8 BattleScript_BlockedByPrimalWeatherEnd[];
...
extern const u8 BattleScript_MimicryActivatesEnd[];
extern const u8 BattleScript_ApplyMimicry[];
extern const u8 BattleScript_AttackerFormChangeEndNoPopup[];
extern const u8 BattleScript_AttackerFormChangeWithStringEndNoPopup[];
...
extern const u8 BattleScript_MimicryActivates_End[];
extern const u8 BattleScript_IceFaceNullsDamage[];
extern const u8 BattleScript_BattlerFormChangeWithStringEnd[];
...
extern const u8 BattleScript_BoosterEnergyEnd[];
